...
const DifficultCustomer = function(props) {
  return (
    <>
      <section className={styles.difficultCustomer}>
        <div className={styles.animation_left}>
          <h1 className={styles.offerHeader}>Szkolenie z trudnego klienta</h1>
          <img
...
export default DifficultCustomer
