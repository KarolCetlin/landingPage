...
const ManagerialCommunication = function() {
  return (
    <>
      <section className={styles.managerialCommunication}>
        <h1 className={styles.offerHeader__white}>Komunikacja menadżerska</h1>
        <img
...
export default ManagerialCommunication
